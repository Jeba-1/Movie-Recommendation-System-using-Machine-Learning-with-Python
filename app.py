...
def download_large_files():
    url_movie_list = 'https://drive.google.com/uc?id=14XjnuIYOgqXFdlyw0c4VQrfOiRCDxIFf'  # Replace with actual file ID
    url_similarity = 'https://drive.google.com/uc?id=1WyasBKPeTxCOdhX3Xk7UfOlHJbgqVJvP'  # Replace with actual file ID
    
    gdown.download(url_movie_list, 'movie_list.pkl', quiet=False)
    gdown.download(url_similarity, 'similarity.pkl', quiet=False)
...
movies, similarity = download_large_files()
